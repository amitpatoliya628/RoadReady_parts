                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item" active>SubCategoey</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            while ($row=mysqli_fetch_array($result)) {
                                                ...
                                                $catresult=mysqli_query($conn, $catqry) or exit("subcategory select fail".mysqli_error($conn));
                                                $catrow=mysqli_fetch_array($catresult)
                                                
                                            ?>
                                            <tr>
                                                <td><?php  echo $row['id']; ?></td>
                                                <td><img src="../images_/subcategories/<?php echo $row['image']; ?>" alt="" width="150px"></td>
                                                <td><?php echo $catrow['catname']; ?></td>
                                                <td><?php  echo $row['subcatname']; ?></td>
                                                <td><?php  echo $row['subcatdescription']; ?></td>
                                                <td>
                                                    <a href="subcategory_delete.php?id=<?php echo $row['id']; ?>"><i class="fas fa-trash"></i></a>&nbsp &nbsp  &nbsp &nbsp
                                                    <a href="subcategory_edit.php?id=<?php echo $row['id']; ?>"><i class="fas fa-edit"></i></td></a>
                                            </tr>
                                            <?php
                                            }
                                        ?>
