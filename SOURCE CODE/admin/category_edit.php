                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item" active>Categoey Edit</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                ...
                                <form action="category_update_db.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="catname" name="catname" placeholder="Enter category name" value="<?php echo $row['catname']; ?>">
                                            <input type="hidden" name="id" value="<?php echo $row['id'];  ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Description</label>
                                            <textarea class="form-control" name="catdescription" id="catdescription"><?php echo $row['catdescription']; ?></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="../images_/categories/<?php echo $row['image']; ?>" alt="" width="300px">
                                        </div
                                    </div>
                            <!-- /.card-body -->
