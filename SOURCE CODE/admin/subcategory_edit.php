                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item" active>SubCategoey Edit</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                ...
                                <form action="subcategory_update_db.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="subcatname" name="subcatname" placeholder="Enter category name" value="<?php echo $row['subcatname']; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="../images_/subcategories/<?php echo $row['image']; ?>" alt="" width="300px">
                                        </div
                                    </div>
                            <!-- /.card-body -->
