...
<body>
    ...
    <?php
        ...
        $qry="select w.id, w.user_id, w.product_id, p.productname, p.productprice, p.productdescription, p.image from wishlist w JOIN products p ON w.product_id = p.id where w.user_id = '$user_id' ORDER BY w.id DESC";
        $result=mysqli_query($conn,$qry) or exit("wishlist slect fail". mysqli_error($conn));
        $total=0;
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="wishlist_item_delete.php?id=<?php echo $row['id']; ?>">
