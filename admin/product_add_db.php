...
if(isset($_SESSION['uname'])){
    ...
    if(move_uploaded_file($_FILES['image']['tmp_name'],$path)){
        $qry = "insert into products (catid,subcatid,productname,productprice,productdescription,image) values('".$catid."','".$subcatid."','".$productname."','".$productprice."','".$productdescription."','".$filename."')";
