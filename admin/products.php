                                        ...
                                        <?php
                                            ...
                                            while ($row=mysqli_fetch_array($result)) {
                                                ...
                                                $catrow=mysqli_fetch_array($catresult);
                                                    ...
                                                    $subcatqry = "select subcatname from subcategories where id='".$row['subcatid']."'";
                                                    $subcatresult=mysqli_query($conn, $subcatqry) or exit("subcategory select fail".mysqli_error($conn));
                                                    $subcatrow=mysqli_fetch_array($subcatresult);
                                            ?>
                                            <tr>
                                                <td><?php  echo $row['id']; ?></td>
                                                <td><img src="../images_/products/<?php echo $row['image']; ?>" alt="" width="200px"></td>
                                                <td><?php  echo $catrow['catname']; ?></td>
                                                <td><?php echo $subcatrow['subcatname']; ?></td>
